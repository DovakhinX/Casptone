...
function BookingForm({ state, dispatch, onSubmit }: FormProps) {
    ...
    return (
        <form className='res-form' onSubmit={handleSubmit}>
            ...
            <input type="date" placeholder='Select the date' id="res-date" value={date.toISOString().substring(0, 10)} onChange={(event) => {
            ...
            <input type="number" min="1" max="10" id="guests" value={guest} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setGuest(parseInt(e.target.value))} />
